...
{
    /// <summary>
    /// Input for the CreateVehicleUseCase. Contains the details of the vehicle to be created.
    /// </summary>
    public class CreateVehicleInput : IUseCaseInput
    {
        ...
        public CreateVehicleInput(string brand, string model, string color, DateOnly manufactureDate, string vin, Guid fleetId)
        {
            Brand = brand;
            Model = model;
            Color = color;
